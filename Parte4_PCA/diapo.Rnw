...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=6.5cm,with=6.5cm]{pca1000g.jpg}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=6.5cm,with=6.5cm]{eurpca.jpeg}
\end{center}
\end{figure}
\end{frame}
...
ids<-read.table("20130606_g1k.ped", sep="\t", header=TRUE)
