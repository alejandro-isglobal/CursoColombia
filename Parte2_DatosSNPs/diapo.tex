...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:Matrix':\\\#\# \\\#\#\ \ \ \  expand}}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: Rsamtools}}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# \\\#\# Attaching package: 'VariantAnnotation'}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:base':\\\#\# \\\#\#\ \ \ \  tabulate}}\begin{alltt}
\hlstd{fl}\hlkwb{<-}\hlstr{"17.43921017-43972966.ALL.chr17.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf"}
\hlstd{vcf} \hlkwb{<-} \hlkwd{readVcf}\hlstd{(fl,} \hlstr{"hg19"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .io\_check\_exists(path(con)): file(s) do not exist:\\\#\#\ \  '17.43921017-43972966.ALL.chr17.phase3\_shapeit2\_mvncall\_integrated\_v5a.20130502.genotypes.vcf'}}\begin{alltt}
\hlstd{genos}\hlkwb{<-}\hlkwd{geno}\hlstd{(vcf)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in geno(vcf): object 'vcf' not found}}\begin{alltt}
\hlkwd{names}\hlstd{(genos)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'genos' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'genos' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in snps[snps == "{}0|0"{}] <- 0: object 'snps' not found}}\begin{alltt}
\hlstd{snps[snps}\hlopt{==}\hlstr{"1|1"}\hlstd{]}\hlkwb{<-}\hlnum{2}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in snps[snps == "{}1|1"{}] <- 2: object 'snps' not found}}\begin{alltt}
\hlstd{snps[snps}\hlopt{!=}\hlnum{0} \hlopt{&} \hlstd{snps} \hlopt{!=}\hlnum{2}\hlstd{]}\hlkwb{<-}\hlnum{1}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in snps[snps != 0 \& snps != 2] <- 1: object 'snps' not found}}\begin{alltt}
\hlstd{snps[}\hlnum{1}\hlopt{:}\hlnum{5}\hlstd{,}\hlnum{1}\hlopt{:}\hlnum{5}\hlstd{]}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'snps' not found}}\begin{alltt}
\hlkwd{save}\hlstd{(snps,} \hlkwc{file}\hlstd{=}\hlstr{"snpsMAPT.RData"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in save(snps, file = "{}snpsMAPT.RData"{}): object 'snps' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in t(snps): object 'snps' not found}}\begin{alltt}
\hlstd{snpsnew[snps}\hlopt{==}\hlstr{"0"}\hlstd{]} \hlkwb{<-} \hlnum{1}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in snpsnew[snps == "{}0"{}] <- 1: object 'snpsnew' not found}}\begin{alltt}
\hlstd{snpsnew[snps}\hlopt{==}\hlstr{"1"}\hlstd{]} \hlkwb{<-} \hlnum{2}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in snpsnew[snps == "{}1"{}] <- 2: object 'snpsnew' not found}}\begin{alltt}
\hlstd{snpsnew[snps}\hlopt{==}\hlstr{"2"}\hlstd{]} \hlkwb{<-} \hlnum{3}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in snpsnew[snps == "{}2"{}] <- 3: object 'snpsnew' not found}}\begin{alltt}
\hlstd{snpsSNPstats} \hlkwb{<-} \hlkwd{new}\hlstd{(}\hlstr{"SnpMatrix"}\hlstd{, snpsnew)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in initMatrix(.Object, ...): object 'snpsnew' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .class1(object): object 'snpsSNPstats' not found}}\begin{alltt}
\hlkwd{save}\hlstd{(snpsSNPstats,} \hlkwc{file}\hlstd{=}\hlstr{"snpsSNPstats.RData"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in save(snpsSNPstats, file = "{}snpsSNPstats.RData"{}): object 'snpsSNPstats' not found}}\end{kframe}
\end{knitrout}
