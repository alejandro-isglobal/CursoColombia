...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{plink.png}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{command.png}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{snpstats.png}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{home1k.png}
\end{center}
\end{figure}
...
\begin{frame}[fragile]
\frametitle{1000 Genomes}
Tambien hay un browser para bajar datos de regiones \begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{mapt.png}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{gettvcf.png}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{cvf1.png}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{cvf2.png}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{variantaanot.png}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{vineta.png}
\end{center}
\end{figure}
\end{frame}
...
fl<-"17.43921017-43972966.ALL.chr17.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf"
vcf <- readVcf(fl, "hg19")
genos<-geno(vcf)
names(genos)
dim(genos$GT)
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=3cm,with=3cm]{plink1kgenomes.png}
\end{center}
\end{figure}
...
\begin{verbatim}
acaceres@IMW00680:~$ plink --bfile [filename prefix] --recode vcf --out [VCF prefix]
acaceres@IMW00680:~$ plink --vcf [VCF filename] --out [.bed/.bim/.fam prefix]
\end{verbatim}
